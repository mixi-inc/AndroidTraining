...
1. (実習) LinearLayoutPractice の 1 と 2 に取り組んでください。
  * [LinearLayoutPractice1 のスクリーンショット]({{site.baseurl}}/assets/02-01/practice/practice_1_sample.png)
  * [LinearLayoutPractice2 のスクリーンショット]({{site.baseurl}}/assets/02-01/practice/practice_2_sample.png)
2. (実習) RelativeLayoutPractice の 1 と 2 に取り組んでください。
  * [RelativeLayoutPractice1 のスクリーンショット]({{site.baseurl}}/assets/02-01/practice/practice_3_sample.png)
  * [RelativeLayoutPractice2 のスクリーンショット]({{site.baseurl}}/assets/02-01/practice/practice_4_sample.png)
3. (実習) FrameLayoutPractice の 1 と 2 に取り組んでください。
  * [FrameLayoutPractice1 のスクリーンショット]({{site.baseurl}}/assets/02-01/practice/practice_5_sample.png)
  * [FrameLayoutPractice2 のスクリーンショット]({{site.baseurl}}/assets/02-01/practice/practice_6_sample.png)
4. (実習) ScrollViewPractice の 1 に取り組んでください。
  * [ScrollViewPractice1 のスクリーンショット]({{site.baseurl}}/assets/02-01/practice/practice_7_sample.png)
