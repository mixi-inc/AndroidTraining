...
![ActionBar Basics](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-05/action_bar_basics.png)
...
![Standard Navigation](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-05/action_bar_standard_navigation.png)

#### List Navigation

ドロップダウンのリストから、項目を 1 つ選択してコンテンツを切り替えるタイプのナビゲーションモードです。

![List Navigation](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-05/action_bar_list_navigation_1.png)

![List Navigation](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-05/action_bar_list_navigation_2.png)
...
![Tab Navigation](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-05/action_bar_tab_navigation.png)

![Tab Navigation](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-05/action_bar_tab_navigation_land.png)
...
<tr>
<td>never</td>
<td>常に ActionBar 上には表示せず、その他のメニュー（3 つの点のアイコン）の中にまとめられます。最も重要度が引くい項目に適用します。</td>
</tr>
<tr>
<td>withText</td>
...
![Action Item](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-05/action_bar_action_item.png)

`ifRoom`指定して画面に入りきらなかったものと、`never`指定したものは、下記のように Overflow にまとめられます。

![Action Item](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-05/action_bar_action_item_overflow.png)

また、アイコンを設定せず、ラベルのみを設定した場合で、Action Item に並べられるときは、全て大文字になって表示されます。

![Action Item](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-05/action_bar_action_item_text.png)
...
![App Icon Navigation Difference](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-05/actionbar-logo.png)
...
![Split ActionBar](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-05/action_bar_split_action_bar.png)
