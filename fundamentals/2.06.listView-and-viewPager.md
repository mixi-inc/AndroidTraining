...
![listview](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-06/listview.png)
...
![custom_list_item_layout](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-06/custom_list_item_layout.png)
...
![custom_list_item](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-06/custom_list_item.png)
...
![recycle_list_item](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-06/recycle_list_item.png)
...
ヒント:ListView には smoothScrollToPosition メソッドがあります。
  * [スクリーンショット](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-06/practice/practice_2_sample.png)
3. (課題) 以下のListViewを表示するように実装してください。
  * [スクリーンショット](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-06/assignment/assignment_1_sample.png)  
ListAdapterには予め用意されているBookクラスを使用するようにして下さい。
4. (課題) 課題3で作成したListViewをタップしたら、次画面に遷移してタップしたアイテムの情報を表示するようにしてください。  
  * [スクリーンショット](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-06/assignment/assignment_2_sample.png)  
...
ヒント:データの追加、削除、表示の更新処理はAdapterで行います。
  * [スクリーンショット](https://raw.github.com/mixi-inc/AndroidTraining/master/docs/resources/images/02-06/assignment/assignment_3_sample.png)  
