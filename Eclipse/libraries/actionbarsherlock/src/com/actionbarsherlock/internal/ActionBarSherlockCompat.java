...
public class ActionBarSherlockCompat extends ActionBarSherlock
  ...
  private void updateProgressBars(int value) {
    ...
    if (value == Window.PROGRESS_VISIBILITY_ON) {
      if ((features & (1 << Window.FEATURE_PROGRESS)) != 0) {
        ...
        int visibility =
            (horizontalProgressBar.isIndeterminate() || level < 10000)
                ? View.VISIBLE
                : View.INVISIBLE;
    ...
    if (mContentParent == null) {
      ...
      if (wActionBar != null) {
        ...
        if (splitView != null) {
          ...
          Log.e(
              TAG, "Requested split action bar with incompatible window decor! Ignoring request.");
        }
  ...
  private ViewGroup generateLayout() {
    ...
    if (BuildConfig.DEBUG)
      Log.d(
          TAG,
          "[generateLayout] using screen XML "
