...
public class ActionMenuItemView extends LinearLayout
  ...
  private final Set<View_OnAttachStateChangeListener> mListeners =
      new HashSet<View_OnAttachStateChangeListener>();
  ...
  public ActionMenuItemView(Context context, AttributeSet attrs, int defStyle) {
    ...
    super(context, attrs);
    mAllowTextWithIcon =
        getResources_getBoolean(context, R.bool.abs__config_allowActionMenuItemTextWithIcon);
    TypedArray a =
        context.obtainStyledAttributes(attrs, R.styleable.SherlockActionMenuItemView, 0, 0);
  ...
  public boolean onLongClick(View v) {
    ...
    if (midy < displayFrame.height()) {
      ...
      cheatSheet.setGravity(
          Gravity.TOP | Gravity.RIGHT, screenWidth - screenPos[0] - width / 2, height);
    } else {
  ...
  protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    final int targetWidth =
        widthMode == MeasureSpec.AT_MOST ? Math.min(specSize, mMinWidth) : mMinWidth;
