...
public class MenuBuilder implements Menu {
  ...
  private static final int[] sCategoryToOrder =
      new int[] {
        1, /* No category */ 4, /* CONTAINER */ 5, /* SYSTEM */ 3, /* SECONDARY */
        2, /* ALTERNATIVE */ 0, /* SELECTED_ALTERNATIVE */
      };
  ...
  /**
   * Whether the shortcuts should be visible on menus. Use isShortcutsVisible() instead of accessing
   * this directly.
   */
  ...
  /**
   * Contains only the items that are currently visible. This will be created/refreshed from {@link
   * #getVisibleItems()}
   */
  private ArrayList<MenuItemImpl> mVisibleItems;
  /**
   * Whether or not the items (or any one item's shown state) has changed since it was last fetched
   * from {@link #getVisibleItems()}
   */
  ...
  /**
   * Prevents onItemsChanged from doing its junk, useful for batching commands that may individually
   * call onItemsChanged.
   */
   ...
   * bits.
   *
   * @param categoryOrder The category order for a particular item (if it has not been or/add with a
   *     category, the default category is assumed).
   * @return An ordering integer that can be used to order this item across all the items (even from
   *     other categories).
   */
  ...
  /**
   * Sets whether the shortcuts should be visible on menus. Devices without hardware key input will
   * never make shortcuts visible even if this method is passed 'true'.
   *
   ...
   *     changed. (Visibility is a structural property since it affects layout.)
   */
