...
public class DialogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.show_assignmentdialog).setOnClickListener(new View.OnClickListener() {
    ...
    public static class AssignmentDialogFragment extends AppCompatDialogFragment {
